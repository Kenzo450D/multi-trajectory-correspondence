function [newMatchesMade] = icpSupervisedMainDataPassed(vertices1, vertices2, landmarks1, landmarks2, gtPoseAssc, landmarkAssc, atePrecisionFile, outMatICPFileName)
